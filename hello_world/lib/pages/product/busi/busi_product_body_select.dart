      ...
      child: Column(
        children: <Widget>[
          Padding(
            ...
            child: Row(
              children: <Widget>[
                Text('规格',style: TextStyle(fontSize: ThemeSize.fontSizeMid,color: Colors.grey)),
                Padding(
                  padding: EdgeInsets.only(left: ThemeSize.marginSizeMid),
                  child: Text('未选择',style: TextStyle(fontSize: ThemeSize.fontSize14,color: ThemeColors.colorFont_333)),
                )
              ],
            ),
          ),
          Row(
            children: <Widget>[
              Text('运费',style: TextStyle(fontSize: ThemeSize.fontSizeMid,color: Colors.grey)),
              Padding(
                padding: EdgeInsets.only(left: ThemeSize.marginSizeMid),
                child: Text('全国包邮',style: TextStyle(fontSize: ThemeSize.fontSize14,color: ThemeColors.colorFont_333)),
              )
            ],
          ),
        ],
