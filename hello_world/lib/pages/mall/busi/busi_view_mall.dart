...
class MallViewState extends State<MallView> {
  ...
  Padding buildRightItemLayout(List<ModelProductTypechild> selectedChild, int j) {
    return Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      Align(
                        ...
                        child: Text(selectedChild[j].name,style: TextStyle(color: ThemeColors.colorFont_333,fontSize: ThemeSize.fontSizeMid)),
                      ),
                      ComGridView(selectedChild[j].children, buildItemLayoutOfRightItemChild, 3,
  ...
  Widget buildItemLayoutOfRightItemChild(item,index){
    ...
    return Expanded(
      ...
      child: Column(
        children: <Widget>[
          Image.network(_item.img??'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1583005356676&di=fc5b4f9709aedf34bd4505e5c0df8a1e&imgtype=0&src=http%3A%2F%2Fhbimg.b0.upaiyun.com%2F1e3ead27ad747c7c92e659ac5774587a680bb8d25252-mRVFlu_fw658',
              width: ScreenUtil().setWidth(60),
              height: ScreenUtil().setWidth(60),
              fit: BoxFit.fill),
          Text(_item.name,maxLines: 1,overflow: TextOverflow.ellipsis,style: TextStyle(color: ThemeColors.colorFont_333,fontSize: ThemeSize.fontSize14),)
        ],
      ),
    );
  }
