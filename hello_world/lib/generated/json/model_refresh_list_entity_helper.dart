...
modelRefreshListEntityFromJson(
    ModelRefreshListEntity data, Map<String, dynamic> json) {
  if (json['total'] != null) {
...
Map<String, dynamic> modelRefreshListEntityToJson(
    ModelRefreshListEntity entity) {
