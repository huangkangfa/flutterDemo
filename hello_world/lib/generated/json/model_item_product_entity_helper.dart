...
modelItemProductEntityFromJson(ModelItemProductEntity data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> modelItemProductEntityToJson(ModelItemProductEntity entity) {
