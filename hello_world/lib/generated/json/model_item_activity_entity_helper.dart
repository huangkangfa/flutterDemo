...
modelItemActivityEntityFromJson(ModelItemActivityEntity data, Map<String, dynamic> json) {
	if (json['id'] != null) {
...
Map<String, dynamic> modelItemActivityEntityToJson(ModelItemActivityEntity entity) {
