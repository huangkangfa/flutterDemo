...
modelBannerListEntityFromJson(
    ModelBannerListEntity data, Map<String, dynamic> json) {
  if (json['total'] != null) {
...
modelBannerListDataFromJson(
    ModelBannerListData data, Map<String, dynamic> json) {
  if (json['id'] != null) {
