...
class JsonConvert<T> {
    ...
    switch (type) {			case ModelRefreshListEntity:
			return modelRefreshListEntityFromJson(data as ModelRefreshListEntity, json) as T;			case ModelComIconEntity:
			return modelComIconEntityFromJson(data as ModelComIconEntity, json) as T;			case ModelProductTypeEntity:
			...
			return modelProductTypechildchildFromJson(data as ModelProductTypechildchild, json) as T;			case ModelItemProductEntity:
			return modelItemProductEntityFromJson(data as ModelItemProductEntity, json) as T;			case ModelItemActivityEntity:
			return modelItemActivityEntityFromJson(data as ModelItemActivityEntity, json) as T;			case ModelItemShopEntity:
			return modelItemShopEntityFromJson(data as ModelItemShopEntity, json) as T;			case ModelUserEntity:
			return modelUserEntityFromJson(data as ModelUserEntity, json) as T;			case ModelBannerListEntity:
			return modelBannerListEntityFromJson(data as ModelBannerListEntity, json) as T;			case ModelBannerListData:
			return modelBannerListDataFromJson(data as ModelBannerListData, json) as T;			case ModelItemIconEntity:
			return modelItemIconEntityFromJson(data as ModelItemIconEntity, json) as T;    }
    return data as T;
  }  static _getToJson<T>(Type type, data) {
		switch (type) {			case ModelRefreshListEntity:
			return modelRefreshListEntityToJson(data as ModelRefreshListEntity);			case ModelComIconEntity:
			return modelComIconEntityToJson(data as ModelComIconEntity);			case ModelProductTypeEntity:
			...
			return modelProductTypechildchildToJson(data as ModelProductTypechildchild);			case ModelItemProductEntity:
			return modelItemProductEntityToJson(data as ModelItemProductEntity);			case ModelItemActivityEntity:
			return modelItemActivityEntityToJson(data as ModelItemActivityEntity);			case ModelItemShopEntity:
			return modelItemShopEntityToJson(data as ModelItemShopEntity);			case ModelUserEntity:
			return modelUserEntityToJson(data as ModelUserEntity);			case ModelBannerListEntity:
			return modelBannerListEntityToJson(data as ModelBannerListEntity);			case ModelBannerListData:
			return modelBannerListDataToJson(data as ModelBannerListData);			case ModelItemIconEntity:
    ...
    switch (T.toString()) {			case 'ModelRefreshListEntity':
			return ModelRefreshListEntity().fromJson(json) as T;			case 'ModelComIconEntity':
			return ModelComIconEntity().fromJson(json) as T;			case 'ModelProductTypeEntity':
			...
			return ModelProductTypechildchild().fromJson(json) as T;			case 'ModelItemProductEntity':
			return ModelItemProductEntity().fromJson(json) as T;			case 'ModelItemActivityEntity':
			return ModelItemActivityEntity().fromJson(json) as T;			case 'ModelItemShopEntity':
			return ModelItemShopEntity().fromJson(json) as T;			case 'ModelUserEntity':
			return ModelUserEntity().fromJson(json) as T;			case 'ModelBannerListEntity':
			return ModelBannerListEntity().fromJson(json) as T;			case 'ModelBannerListData':
			return ModelBannerListData().fromJson(json) as T;			case 'ModelItemIconEntity':
