...
class JsonConvert<T> {
    ...
    switch (type) {			case ModelRefreshListEntity:
			...
			return modelUserEntityFromJson(data as ModelUserEntity, json) as T;			case ModelItemIconEntity:
    ...
    return data as T;
		...
		switch (type) {			case ModelRefreshListEntity:
			...
			return modelUserEntityToJson(data as ModelUserEntity);			case ModelItemIconEntity:
    ...
    switch (T.toString()) {			case 'ModelRefreshListEntity':
			...
			return ModelUserEntity().fromJson(json) as T;			case 'ModelItemIconEntity':
